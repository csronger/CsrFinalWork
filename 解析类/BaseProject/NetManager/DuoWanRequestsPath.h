...
#ifndef DuoWanRequestsPath_h
#define DuoWanRequestsPath_h
...
//英雄配音
#define kHeroSoundPath @"ttp://box.dwstatic.com/apiHeroSound.php"
//英雄视频
...
//英雄排行
#define kHeroTopPath @"http://lolbox.duowan.com/phone/heroTop10PlayersNew.php"
//天赋符文
#define kHeroGiftPath @"http://box.dwstatic.com/apiHeroSuggestedGiftAndRun.php"
//评论
#define kHeroIndexPath @"http://comment3.duowan.com/index.php"
//查战绩
#define kPlayerSearchNewPath @"http://lolbox.duowan.com/phone/playerSearchNew.php"
//英雄改动
...
//最佳阵容
#define kHeroBestGroupPath @"http://box.dwstatic.com/apiHeroBestGroup.php"
//LOL个性关键词查询
#define kIndexMain @"http://service.mbox.duowan.com/index.php"
//LOL小说
#define kBoxPath @"http://m.ouj.com/boxn "
#endif /* DuoWanRequestsPath_h */
